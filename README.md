## 🧪 From theory to practice: Exploring oscillators with simple models – Hands-on workshop
All exercises for this workshop are provided as interactive Jupyter notebooks that run directly in **Google Colab**. No Python installation is required. 
